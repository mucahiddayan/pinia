...
export const useTodos = defineStore('todos', ()=>{
  ...
  const addTodo = text => todos.value.push({ text, id: nextId.value++, isFinished: false })
  
  return {todos,filter,nextId,finishedTodos,unfinishedTodos,addTodo,filteredTodos};
